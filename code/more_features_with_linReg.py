...
for segment in tqdm(range(segments)):
    ...
    X_train.loc[segment, 'pp'] = (x.abs().max()+x.abs().min())*(x.abs().max()+x.abs().min())
	...
	X_train.loc[segment, 'pp_mean_{window}' ] = (data_roll_mean.abs().max()+data_roll_mean.abs().min())*(data_roll_mean.abs().max()+data_roll_mean.abs().min())
...
for seg_id in X_test.index:
    ...
    X_test.loc[seg_id, 'pp'] = (x.abs().max()+x.abs().min())*(x.abs().max()+x.abs().min())
	...
	X_test.loc[seg_id, 'pp_mean_{window}' ] = (data_roll_mean.abs().max()+data_roll_mean.abs().min())*(data_roll_mean.abs().max()+data_roll_mean.abs().min())
